...
preflight() {
    ...
    # Resolve the bench node's k8s name for checkpoint cleanup later.
...
run_criu_thaw_benchmark() {
    ...
    for (( i=1; i<=ITERATIONS; i++ )); do
        ...
        # Purge leftover CRIU checkpoint dirs periodically to prevent
        # disk-pressure taints on the bench node.
